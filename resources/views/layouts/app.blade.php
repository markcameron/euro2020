            ...
            <footer class="h-22">
                <div class="bg-euro-light text-white">
                    <nav class="flex flex-row">
                        <button class="flex-1 uppercase text-xs text-white py-4 px-6 block hover:text-blue-500 focus:outline-none text-euro-darkest border-t-2 font-medium border-euro-darkest">
                        ...
                        <button class="flex-1 uppercase text-xs text-white py-4 px-6 block hover:text-blue-500 focus:outline-none">
